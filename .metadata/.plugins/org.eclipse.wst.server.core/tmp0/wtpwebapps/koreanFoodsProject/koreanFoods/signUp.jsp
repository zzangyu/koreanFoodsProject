...
<body>
	<form action="kfoods.do?cmd=signUpProc" id="signUp" method="post">
		<div id="signUp_Wrap">
			...
			<div>
				...
				<div>
					<input type="text" name="kf_nickname" id="kf_nickname" class="signUp_input" onkeyup="nickCheck()">
			...
			<div>
				...
				<div>
					<input type="text" name="kf_email" id="kf_email" class="signUp_input" onkeyup="emailCheck()">
					<div class="signUp_check_textSize" id="signUp_emailCheck"></div>
				</div>
			</div>
			<button type="submit" class="signUp_button1">회원가입</button><button class="signUp_button1" type="button" onClick="location.href='kfoods.do?cmd=signIn'">로그인</button>
